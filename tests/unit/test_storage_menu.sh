...
assert_contains "$selector" '1) run_sector_safe "$SECTOR_DIR/40-storage-preflight.sh" ;;'
assert_contains "$selector" '4) run_sector_safe "$SECTOR_DIR/43-storage-layout.sh" --dry-run ;;'
assert_contains "$selector" '5) run_sector_safe "$SECTOR_DIR/43-storage-layout.sh" --apply ;;'
assert_contains "$selector" '6) run_sector_safe "$SECTOR_DIR/44-storage-validate.sh" ;;'
assert_contains "$selector" '7) run_sector_safe "$SECTOR_DIR/47-storage-report.sh" ;;'
